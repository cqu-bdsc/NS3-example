...
#ifndef DATATX_APPLICATION_H
#define DATATX_APPLICATION_H
 ...
 * \defgroup onoff DataTxApplication
 *
...
*/
class DataTxApplication : public Application
{
public:
  /**

...
public:
  ...
  uint32_t GetSatisfiedReqsOneSchedule () const;

  void IncSatisfiedReqsOneSchedule ();

  void ResetSatisfiedReqsOneSchedule ();
  ...
  uint32_t GetV2vTxPkts () const;

  void IncV2vTxPkts ();

  uint32_t GetV2vRxPkts () const;

  void IncV2vRxPkts ();

  uint32_t GetV2fTxPkts () const;

  void IncV2fTxPkts ();

  uint32_t GetV2fRxPkts () const;

  void IncV2fRxPkts ();

private:
  uint32_t m_submittedReqs; ///< number of packets submitted
  uint32_t m_satisfiedReqs; ///< number of packets satisfied
  uint32_t m_satisfiedReqsOneSchedule; ///< number of requests satisfied during current schedule
  uint32_t m_broadcastPkts; ///< number of packets broadcast by BS
  double m_cumulativeDelay; ///< cumulative delay

  uint32_t m_v2vTxPkts;
  uint32_t m_v2vRxPkts;
  uint32_t m_v2fTxPkts;
  uint32_t m_v2fRxPkts;
};

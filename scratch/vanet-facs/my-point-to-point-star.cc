...
NS_LOG_COMPONENT_DEFINE ("MyPointToPointStarHelper");

MyPointToPointStarHelper::MyPointToPointStarHelper ()
{
}

MyPointToPointStarHelper::MyPointToPointStarHelper (uint32_t numSpokes,
...
MyPointToPointStarHelper::MyPointToPointStarHelper (NodeContainer spokes,
                                                    PointToPointHelper p2pHelper)
{
  m_hub.Create (1);
  m_spokes.Add (spokes);
...
Ptr<Node>
MyPointToPointStarHelper::GetHub () const
{
  return m_hub.Get (0);
}

Ptr<Node>
MyPointToPointStarHelper::GetSpokeNode (uint32_t i) const
{
  return m_spokes.Get (i);
}

Ipv4Address
MyPointToPointStarHelper::GetHubIpv4Address (uint32_t i) const
{
  return m_hubInterfaces.GetAddress (i);
}

Ipv4Address
MyPointToPointStarHelper::GetSpokeIpv4Address (uint32_t i) const
{
  return m_spokeInterfaces.GetAddress (i);
}

Ipv6Address
MyPointToPointStarHelper::GetHubIpv6Address (uint32_t i) const
{
  return m_hubInterfaces6.GetAddress (i, 1);
}

Ipv6Address
MyPointToPointStarHelper::GetSpokeIpv6Address (uint32_t i) const
{
  return m_spokeInterfaces6.GetAddress (i, 1);
}

uint32_t
MyPointToPointStarHelper::SpokeCount () const
{
  return m_spokes.GetN ();
}

void 
MyPointToPointStarHelper::InstallStack (InternetStackHelper stack)
{
  stack.Install (m_hub);
...
void 
MyPointToPointStarHelper::AssignIpv4Addresses (Ipv4AddressHelper address)
{
  for (uint32_t i = 0; i < m_spokes.GetN (); ++i)
    {
...
void 
MyPointToPointStarHelper::AssignIpv6Addresses (Ipv6Address addrBase, Ipv6Prefix prefix)
{
...
void 
MyPointToPointStarHelper::BoundingBox (double ulx, double uly,

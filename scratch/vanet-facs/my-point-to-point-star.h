...
#ifndef MY_POINT_TO_POINT_STAR_HELPER_H
#define MY_POINT_TO_POINT_STAR_HELPER_H
 ...
 */
class MyPointToPointStarHelper
{
public:
  MyPointToPointStarHelper ();
  /**
   * Create a MyPointToPointStarHelper in order to easily create
   ...
   */
  MyPointToPointStarHelper (uint32_t numSpokes,
                            PointToPointHelper p2pHelper);

  MyPointToPointStarHelper (NodeContainer spokes,
                            PointToPointHelper p2pHelper);
...
#endif /* MY_POINT_TO_POINT_STAR_HELPER_H */

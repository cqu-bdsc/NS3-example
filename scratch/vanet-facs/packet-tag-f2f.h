...
public:
  ...
  void SetDestObusIdx (std::vector<uint32_t> destObuIdx);
  std::vector<uint32_t> GetDestObusIdx (void) const;
...
private:
  std::vector<uint32_t> m_destObusIdx; // index of destination obu
